...
{//runs when new game and no save game present
   ...
   var timer = 0;
   var timer1 = 0;
   var timer2 = 0; //timer alive for #38 and similar
   var timer3 = 0; //timer airborne for #39
   var timer4 = 0; //uneventful timer
   var timer5 = 0; //for chain reaction achievements
   var timer6 = 0; //marathon timer
   var timer7 = 0; //rally
   var timer8 = 0;
   var timer9 = 0;  
